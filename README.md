...
~~ Source super_dev  For Supergroups 

+~~Developer By : @p444p On Telegram ,
...
git clone https://github.com/ahmedjabbar/super_dev.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf superflux-bot && rm -rf .telegram-cli && git clone https://github.com/ahmedjabbar/super_dev.git && cd super_ved && ./launch.sh install && ./launch.sh
~~~~~
